...
public:
    ...
    const QVector3D GetMaterialAmbient(unsigned int material_index) const
    {
        return QVector3D(m_material[material_index].ambient.x, m_material[material_index].ambient.y, m_material[material_index].ambient.z);
    }

    const QVector3D GetMaterialDiffuse(unsigned int material_index) const
    {
        return QVector3D(m_material[material_index].diffuse.x, m_material[material_index].diffuse.y, m_material[material_index].diffuse.z);
    }
